...
// ---------------------------------------------------------
			...
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '60px', 'lineheight' => '72px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '49px', 'lineheight' => '34px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '40px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#008d96'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '27px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '49px', 'lineheight' => '34px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '20px', 'lineheight' => '35px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
