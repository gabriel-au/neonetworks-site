...
/* Skills */
function my_post_type_skills() {
	register_post_type( 'skills',
		array( 
				'label'             => __('Skills', CURRENT_THEME), 
				'public'            => true, 
				'show_ui'           => true,
				'show_in_nav_menus' => false,
				'menu_position'     => 5,
	...
	register_taxonomy('skills_category', 'skills', array('hierarchical' => true, 'label' => theme_locals("categories"), 'singular_name' => theme_locals("category"), 'rewrite' => true, 'query_var' => true));

}
add_action('init', 'my_post_type_skills');
